...
If you want to use this extension, you need to add the `io.quarkiverse.angus-mail:quarkus-angus-mail` extension first to your build file.
...
include::includes/quarkus-angus-mail.adoc[leveloffset=+1, opts=optional]
